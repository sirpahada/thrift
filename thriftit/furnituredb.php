...
$sql ="INSERT INTO ad(category, ad_title, description, price, image, contact_number)VALUES('$category','$ad_title','$description','$price', '$image', '$contact')";
// execute query
  	mysqli_query($db, $sql);
//mysqli_query($conn, $sql);
    ...
    header("Location : furniture1.php");
  }
