<HTML>
 <!-- main page,,,username lekhne wala  yeta bata logindb ma -->
	<HEAD>
	...
	<BODY>
		...
		<form action="logindb.php" method="post">
			<box>
				...
				<center><i>Don't have an account?</i> <a href="loginandregis.php">Sign Up here</a></center>
			</box>
		</form><br><br><br><br><br>
		...
		<h2><center>Popular ADs</center></h2><hr>
